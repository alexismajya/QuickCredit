const setLogoPosition=()=>{
	viewUsers();
	var formseiz=document.getElementById('form_viewloans').clientHeight;
...
const tablecells=(Id,user,date,status,repaid,tenor,amount,inst,balance,interest)=>{
	...
	newrow.insertCell(10).innerHTML='<input type="button" class="tablebutton" value="Approve"/> <input type="button" class="tablebutton" id="reject" value="Reject"/> ';
}
const viewUsers=()=>{
	var UserArray=[];
